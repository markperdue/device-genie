...
//Send PUT to checkin api
$ch = curl_init();
	
$api = '/rest/v1/device/';
$url = $dc_base_url . $api . $device . '/checkin';
...
// Add in message data if it exists
if (!IsNullOrEmptyString($note)) {
	$xml_data = "<message>" . $note . "</message>";
...
if ($status_code === 200) {
	$header = "Success!";
	$message = "Device '".$device."' was checked in.";
}
else {
	$header = "Oh boy...";
...
<html>
<head>
	<title>DeviceGenie - Checkin</title>
